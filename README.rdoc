...
Captain provides a rake task to build an Ubuntu installation CD just as you
like it.
...
With the following +Rakefile+:
 ...
 require 'captain'
 Captain::Rake::ISOTask.new

Captain builds an i386 Jaunty CD:
...
A second rake task, Captain::Rake::VMwareTask, is provided to help you play
around with your ISO image:

 require 'captain'

 iso_task = Captain::Rake::ISOTask.new do |task|
